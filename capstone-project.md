...
My 'Dealing with the Devils: Fairness Challenges of a 19-Team AFL Fixture' capstone dissertation (in progress) addresses a complex combinatorial optimisation challenge to achieve fairness in Australian Football League (AFL) match scheduling. 
